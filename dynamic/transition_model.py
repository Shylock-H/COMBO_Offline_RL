...
import torch
import os
from util.helper import minibatch_inference
from dynamic.ensemble_dynamics import EnsembleModel
from operator import itemgetter
from util.normalizer import StandardNormalizer
...
class TransitionModel:
    def __init__(self,
        ...
        self.model = EnsembleModel(obs_dim=obs_dim, action_dim=action_dim, hidden_dims = kwargs['model']['hidden_dims'], device = DEVICE)
    ...
    def save_model(self, info):
        ...
        save_dir = os.path.join('./log/', 'models')
